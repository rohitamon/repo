...
QT_MOC_LITERAL(1, 7, 8), // "joystick"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 10), // "button_val"
QT_MOC_LITERAL(4, 28, 8), // "axis_val"
QT_MOC_LITERAL(5, 37, 9) // "direction"

    },
    "Thread\0joystick\0\0button_val\0axis_val\0"
    "direction"
};
...
void Thread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Thread::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Thread::joystick)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Thread::*)(int , bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Thread::button_val)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (Thread::*)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Thread::axis_val)) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Thread::direction)) {
                *result = 3;
                return;
            }
        }
...
// SIGNAL 1
void Thread::button_val(int _t1, bool _t2)
{
...
// SIGNAL 2
void Thread::axis_val(int _t1, int _t2)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))), const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t2))) };
...
// SIGNAL 3
void Thread::direction(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
