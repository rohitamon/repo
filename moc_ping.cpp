...
QT_MOC_LITERAL(1, 5, 4), // "code"
QT_MOC_LITERAL(2, 10, 0), // ""
QT_MOC_LITERAL(3, 11, 2), // "no"
QT_MOC_LITERAL(4, 14, 12), // "verifyStatus"
QT_MOC_LITERAL(5, 27, 10) // "readResult"

    },
    "ping\0code\0\0no\0verifyStatus\0readResult"
};
...
void ping::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->code((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->verifyStatus(); break;
        case 2: { QString _r = _t->readResult();
        ...
        {
            using _t = void (ping::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ping::code)) {
                *result = 0;
                return;
            }
        }
